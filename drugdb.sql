...
-- -----------------------------------------------------------
-- Table `drugdb`.`Template_library_file_path`
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `drugdb`.`Template_library_file_path` (
...
-- --------------------------------------------------
-- Table `drugdb`.`Template_library`
-- --------------------------------------------------
CREATE TABLE IF NOT EXISTS `drugdb`.`Template_library` (
...
-- -------------------------------------------------------
-- Table `drugdb`.`Template_library_file`
-- -------------------------------------------------------
CREATE TABLE IF NOT EXISTS `drugdb`.`Template_library_file` (
  ...
  CONSTRAINT `fk_Template_library_file_Template_library1`
    ...
    REFERENCES `drugdb`.`Template_library` (`Template_library_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `drugdb`.`Rnai_screen_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `drugdb`.`Rnai_screen_info` (
  ...
  CONSTRAINT `fk_Rnai_screen_info_Template_library_file_path1`
    ...
    REFERENCES `drugdb`.`Template_library_file_path` (`Template_library_file_path_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `drugdb`.`Plate_excel_file_as_text` (
  ...
  CONSTRAINT `fk_Plate_excel_file_as_text_Rnai_screen_info1`
    ...
    REFERENCES `drugdb`.`Rnai_screen_info` (`Rnai_screen_info_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `drugdb`.`Zscores_result`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `drugdb`.`Zscores_result` (
...
-- GRANT ALL ON `drugdb`.* TO 'AditiGulati';
