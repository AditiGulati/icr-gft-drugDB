...
screen_rownames <- paste(
  wt_screen[,"GeneID"],
  wt_screen[,"Concentration_pM"]/10^6,
  wt_screen[,"Function"],
  sep=":"
)
...
short_summary1 = gsub("_zscores_summary_with_rep_zscores.txt","",summaryFilePath_1)
shorter_summary1 = gsub("summaryFile1_","",short_summary1)
short_summary2 = gsub("_zscores_summary_with_rep_zscores.txt","",summaryFilePath_2)
